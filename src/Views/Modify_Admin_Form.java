 ...
 * @author 1styrGroupC
 */
public class Modify_Admin_Form extends javax.swing.JDialog {
     ...
     */
    public Modify_Admin_Form(java.awt.Frame parent, boolean modal, int adminID) {
        super(parent, modal);
        initComponents();
        adminId = adminID;
        loadInfo();
    ...
    public void loadInfo() {
        try {
            admin = adminController.getAdmin(adminId);
            tfAdminLevel.setSelectedIndex(admin.getLevel());
            tfFirstName.setText(admin.getfName());
            tfLastName.setText(admin.getlName());
            tfMiddleName.setText(admin.getmName());
            tfContactNumber.setText(admin.getContactNumber());
    ...
    private void initComponents() {
        ...
        setTitle("Modify Admin Record Form");
        setResizable(false);
        ...
        jLabel1.setText("Modify Admins Record Form");
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        admin.setfName(tfFirstName.getText().toUpperCase());
        admin.setmName(tfMiddleName.getText().toUpperCase());
        admin.setlName(tfLastName.getText().toUpperCase());
        admin.setContactNumber(tfContactNumber.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Modify_Admin_Form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Modify_Admin_Form dialog = new Modify_Admin_Form(new javax.swing.JFrame(), true, 0);
